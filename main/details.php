...
<div class="newcontent">
    ...
    <div class="carform">
        <form action="#" method="post">
            <h4>BOOK NOW</h4>
            <input type="date" name="date1" placeholder="From Date (dd/mm/yy)"> <br>

            <input type="date" name="date2" placeholder="To Date (dd/mm/yy)"> <br>

            <textarea placeholder="Message"></textarea> <br>

            <input type="submit" class="submit" name="date1" value="Book">
        </form>
    </div>
